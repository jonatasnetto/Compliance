...
<html>
    ...
    <head>
        ...
        <nav class="navbar col-12 fixed-top navbar-expand-lg navbar-dark bg-dark" style="z-index: 999;">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="gestaousuarios.php">Gestão de usuários</a></li>
                                <li><a class="dropdown-item" href="gestaoservicos.php">Gestão de serviços</a></li>
