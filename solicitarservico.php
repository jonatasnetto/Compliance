...
<html>
    ...
    <body>
        ...
        <div  class="container col-5">
            <h2 class="text-center mg-top">Solicitar serviço</h2>
            <br>
            <form name="insc" action="mailto:jonatasnetto@gmail.com" method="post"
                ...
                <div class="mb-3 row">
                    <div class="col-3">
                        <label for="contacto" class="form-label">Quantidade de usuários</label>
                    </div>
                    <div class="col-8">
                        <input type="number" class="form-control" id="users" name="usuarios" required>
                    </div>
                </div>
                ...
                <button type="submit" class="btn btn-info text-white" value="Submit">Solicitar</button>
