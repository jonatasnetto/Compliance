...
<?php
    ...
    function EditaBD($idServiços, $tipo, $cliente, $total_usuarios, $duracao, $progresso, $valor, $conn){
        ...
        if ($res->num_rows>0){
            ...
            $sql2 = "UPDATE serviços SET tipo = '$tipo', cliente = '$cliente', total_usuarios = '$total_usuarios', duracao = '$duracao', progresso = ' $progresso', valor = '$valor' WHERE idServiços = '$idServiços'";
